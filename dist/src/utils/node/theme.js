...
export async function getArticleMeta(filepath, route, timeZone = defaultTimeZoneOffset) {
...
export async function getArticles(cfg, vpConfig) {
    const srcDir = cfg?.srcDir || vpConfig.srcDir.replace(vpConfig.root, '').replace(/^\//, '')
