  ...
  "node_modules/glob-parent/index.js"(exports2, module2) {
    ...
    module2.exports = function globParent(str2, opts) {
      ...
      if (options2.flipBackslashes && isWin32 && str2.indexOf(slash3) < 0) {
        str2 = str2.replace(backslash, slash3);
      }
  ...
  "node_modules/picomatch/lib/picomatch.js"(exports2, module2) {
    ...
    var picomatch = (glob3, options2, returnState = false) => {
      if (Array.isArray(glob3)) {
        const fns = glob3.map((input) => picomatch(input, options2, returnState));
      ...
      const regex = isState ? picomatch.compileRe(glob3, options2) : picomatch.makeRe(glob3, options2, false, true);
      ...
      const matcher = (input, returnObject = false) => {
        const { isMatch, match, output } = picomatch.test(input, regex, options2, { glob: glob3, posix });
    ...
    picomatch.test = (input, regex, options2, { glob: glob3, posix } = {}) => {
      if (typeof input !== "string") {
...
var require_micromatch = __commonJS({
  "node_modules/micromatch/index.js"(exports2, module2) {
    ...
    micromatch.capture = (glob3, input, options2) => {
      let posix = utils.isWindows(options2);
      let regex = picomatch.makeRe(String(glob3), { ...options2, capture: true });
...
var require_binary = __commonJS({
  "node_modules/js-yaml/lib/js-yaml/type/binary.js"(exports2, module2) {
    ...
    try {
      _require2 = require;
      NodeBuffer = _require2("buffer").Buffer;
    } catch (__) {
    }
    var _require2;
    var Type = require_type();
  ...
  "node_modules/xml-js/lib/options-helper.js"(exports2, module2) {
    ...
    module2.exports = {
      ...
      ensureAlwaysArrayExists: function(options2) {
        if (!("alwaysArray" in options2) || typeof options2.alwaysArray !== "boolean" && !isArray(options2.alwaysArray)) {
...
var require_xml2js = __commonJS({
  "node_modules/xml-js/lib/xml2js.js"(exports2, module2) {
    ...
    function addField(type, value) {
      var key;
      if (options2.compact) {
        if (!currentElement[options2[type + "Key"]] && (isArray(options2.alwaysArray) ? options2.alwaysArray.indexOf(options2[type + "Key"]) !== -1 : options2.alwaysArray)) {
          currentElement[options2[type + "Key"]] = [];
        }
        if (currentElement[options2[type + "Key"]] && !isArray(currentElement[options2[type + "Key"]])) {
          currentElement[options2[type + "Key"]] = [currentElement[options2[type + "Key"]]];
        }
        if (type + "Fn" in options2 && typeof value === "string") {
          value = options2[type + "Fn"](value, currentElement);
        }
        if (type === "instruction" && ("instructionFn" in options2 || "instructionNameFn" in options2)) {
          for (key in value) {
            if (value.hasOwnProperty(key)) {
              if ("instructionFn" in options2) {
                value[key] = options2.instructionFn(value[key], key, currentElement);
              } else {
                var temp = value[key];
                delete value[key];
        ...
        if (isArray(currentElement[options2[type + "Key"]])) {
          currentElement[options2[type + "Key"]].push(value);
        } else {
          currentElement[options2[type + "Key"]] = value;
        }
      } else {
        if (!currentElement[options2.elementsKey]) {
          currentElement[options2.elementsKey] = [];
        }
        var element = {};
        ...
        if (type === "instruction") {
          ...
          if (options2.instructionHasAttributes) {
            ...
            if ("instructionFn" in options2) {
              element[options2.attributesKey] = options2.instructionFn(element[options2.attributesKey], key, currentElement);
            }
          } else {
            if ("instructionFn" in options2) {
              value[key] = options2.instructionFn(value[key], key, currentElement);
          ...
          if (type + "Fn" in options2) {
            value = options2[type + "Fn"](value, currentElement);
          }
          element[options2[type + "Key"]] = value;
        }
        if (options2.addParent) {
    ...
    function manipulateAttributes(attributes) {
      if ("attributesFn" in options2 && attributes) {
        attributes = options2.attributesFn(attributes, currentElement);
      }
      if ((options2.trim || "attributeValueFn" in options2 || "attributeNameFn" in options2 || options2.nativeTypeAttributes) && attributes) {
        ...
        for (key in attributes) {
          if (attributes.hasOwnProperty(key)) {
            ...
            if (options2.nativeTypeAttributes) {
    ...
    function onInstruction(instruction) {
      ...
      if (instruction.name.toLowerCase() === "xml") {
        if (options2.ignoreDeclaration) {
          return;
        }
        currentElement[options2.declarationKey] = {};
        if (Object.keys(attributes).length) {
          currentElement[options2.declarationKey][options2.attributesKey] = attributes;
        }
        if (options2.addParent) {
          currentElement[options2.declarationKey][options2.parentKey] = currentElement;
        }
      } else {
    ...
    function onStartElement(name, attributes) {
      ...
      attributes = manipulateAttributes(attributes);
      if ("elementNameFn" in options2) {
        name = options2.elementNameFn(name, currentElement);
      }
      if (options2.compact) {
        element = {};
        if (!options2.ignoreAttributes && attributes && Object.keys(attributes).length) {
          ...
          for (key in attributes) {
            if (attributes.hasOwnProperty(key)) {
              element[options2.attributesKey][key] = attributes[key];
            }
          }
        }
        if (!(name in currentElement) && (isArray(options2.alwaysArray) ? options2.alwaysArray.indexOf(name) !== -1 : options2.alwaysArray)) {
          currentElement[name] = [];
        }
        ...
        if (!options2.ignoreAttributes && attributes && Object.keys(attributes).length) {
          element[options2.attributesKey] = attributes;
        }
        if (options2.alwaysChildren) {
          element[options2.elementsKey] = [];
        }
        currentElement[options2.elementsKey].push(element);
      }
      element[options2.parentKey] = currentElement;
    ...
    function onEndElement(name) {
      ...
      if (!options2.addParent) {
        delete currentElement[options2.parentKey];
      }
      currentElement = parentElement;
    }
    function onCdata(cdata) {
      if (options2.ignoreCdata) {
        return;
      }
      if (options2.trim) {
        cdata = cdata.trim();
    ...
    exports2.default = function(ins) {
      ...
      var base = {
        ...
        feed: {
          ...
          generator: utils_1.sanitize(options2.generator || config_1.generator)
        }
      };
      if (options2.author) {
      ...
      base.feed.link = [];
      if (options2.link) {
        base.feed.link.push({ _attributes: { rel: "alternate", href: utils_1.sanitize(options2.link) } });
      }
      var atomLink = utils_1.sanitize(options2.feed || options2.feedLinks && options2.feedLinks.atom);
      if (atomLink) {
        base.feed.link.push({ _attributes: { rel: "self", href: utils_1.sanitize(atomLink) } });
      }
      if (options2.hub) {
        base.feed.link.push({ _attributes: { rel: "hub", href: utils_1.sanitize(options2.hub) } });
      }
...
var require_json2 = __commonJS({
  "node_modules/feed/lib/json.js"(exports2) {
    ...
    exports2.default = function(ins) {
      ...
      if (options2.link) {
        feed.home_page_url = options2.link;
      }
      if (options2.feedLinks && options2.feedLinks.json) {
        feed.feed_url = options2.feedLinks.json;
      }
      if (options2.description) {
        feed.description = options2.description;
      }
      if (options2.image) {
        feed.icon = options2.image;
      }
      if (options2.author) {
        feed.author = {};
        if (options2.author.name) {
          feed.author.name = options2.author.name;
        }
        if (options2.author.link) {
          feed.author.url = options2.author.link;
        }
      }
...
var e = function(r2, e2, n2) {
  var t2 = (n2 = n2 || {}).marker || ":", i = t2.charCodeAt(0), o = t2.length, a = n2.validate || function(r3) {
    return r3.trim().split(" ", 2)[0] === e2;
  }, l = n2.render || function(r3, n3, t3, i2, o2) {
    return 1 === r3[n3].nesting && r3[n3].attrJoin("class", e2), o2.renderToken(r3, n3, t3, i2, o2);
  };
  r2.block.ruler.before("fence", "container_" + e2, function(r3, n3, l2, c) {
    var s, f, u, p, d, k, h, m, y = false, v = r3.bMarks[n3] + r3.tShift[n3], b = r3.eMarks[n3];
    if (i !== r3.src.charCodeAt(v)) return false;
    for (s = v + 1; s <= b && t2[(s - v) % o] === r3.src[s]; s++) ;
    if ((u = Math.floor((s - v) / o)) < 3) return false;
    if (s -= (s - v) % o, p = r3.src.slice(v, s), d = r3.src.slice(s, b), !a(d, p)) return false;
    if (c) return true;
    for (f = n3; !(++f >= l2) && !((v = r3.bMarks[f] + r3.tShift[f]) < (b = r3.eMarks[f]) && r3.sCount[f] < r3.blkIndent); ) if (i === r3.src.charCodeAt(v) && !(r3.sCount[f] - r3.blkIndent >= 4)) {
      for (s = v + 1; s <= b && t2[(s - v) % o] === r3.src[s]; s++) ;
      if (!(Math.floor((s - v) / o) < u || (s -= (s - v) % o, (s = r3.skipSpaces(s)) < b))) {
        y = true;
        break;
      }
    }
    return h = r3.parentType, m = r3.lineMax, r3.parentType = "container", r3.lineMax = f, (k = r3.push("container_" + e2 + "_open", "div", 1)).markup = p, k.block = true, k.info = d, k.map = [n3, f], r3.md.block.tokenize(r3, n3 + 1, f), (k = r3.push("container_" + e2 + "_close", "div", -1)).markup = r3.src.slice(v, s), k.block = true, r3.parentType = h, r3.lineMax = m, r3.line = f + (y ? 1 : 0), true;
...
var n = function(r2, n2, t2) {
  return [e, r2, { render: function(e2, n3) {
    var i = e2[n3], o = i.info.trim().slice(r2.length).trim();
    return 1 === i.nesting ? "<div class='timeline-dot'><span class='timeline-dot-title'>" + t2.renderInline(o) + "</span>\n" : "</div>\n";
  } }];
};
var t = function(e2, t2) {
  e2.use.apply(e2, function(r2, e3, n2) {
    if (n2 || 2 === arguments.length) for (var t3, i = 0, o = e3.length; i < o; i++) !t3 && i in e3 || (t3 || (t3 = Array.prototype.slice.call(e3, 0, i)), t3[i] = e3[i]);
    return r2.concat(t3 || Array.prototype.slice.call(e3));
  }([], function(r2, e3) {
    var n2 = "function" == typeof Symbol && r2[Symbol.iterator];
    if (!n2) return r2;
    var t3, i, o = n2.call(r2), a = [];
    try {
      for (; (void 0 === e3 || e3-- > 0) && !(t3 = o.next()).done; ) a.push(t3.value);
    } catch (r3) {
      i = { error: r3 };
    } finally {
      try {
        t3 && !t3.done && (n2 = o.return) && n2.call(o);
      } finally {
        if (i) throw i.error;
      }
    }
...
var timeLimit2 = pLimit2(+(import_node_process3.default.env.P_LIMT_MAX || import_node_os2.default.cpus().length));
function getDefaultTitle2(content) {
  const match = content.match(/^(#+)\s+(.+)/m);
  return match?.[2] || "";
}
var cache2 = /* @__PURE__ */ new Map();
async function getFileLastModifyTime2(url) {
  const cached = cache2.get(url);
  if (cached) {
    return cached;
  }
  let date = await timeLimit2(() => getFileLastModifyTimeByGit2(url));
  if (!date) {
    date = await getFileLastModifyTimeByFs2(url);
  }
  if (date) {
    cache2.set(url, date);
  }
...
function getFileLastModifyTimeByGit2(url) {
  return new Promise((resolve) => {
    const cwd = import_node_path4.default.dirname(url);
    try {
      const fileName = import_node_path4.default.basename(url);
...
async function getFileLastModifyTimeByFs2(url) {
  try {
    const fsStat = await import_node_fs3.default.promises.stat(url);
    return fsStat.mtime;
  } catch {
    return void 0;
  }
...
var isWindows2 = import_node_os2.default.platform() === "win32";
function slash2(p) {
  return p.replace(windowsSlashRE2, "/");
}
function normalizePath2(id) {
  return import_node_path4.default.posix.normalize(isWindows2 ? slash2(id) : id);
}
function formatDate2(d, fmt = "yyyy-MM-dd hh:mm:ss") {
  if (!(d instanceof Date)) {
    d = new Date(d);
  }
  const o = {
...
function getPostsData(srcDir, config, ops) {
  return __async(this, null, function* () {
    ...
    const files = import_fast_glob2.default.sync(`${srcDir}/**/*.md`, { ignore: ["node_modules"], absolute: true });
    ...
    const fileContentPromises = files.reduce((prev, f) => {
      prev[f] = {
        contentPromise: import_fs.default.promises.readFile(f, "utf-8"),
        datePromise: getFileLastModifyTime2(f)
      };
      return prev;
    }, {});
    for (const file of files) {
      ...
      const { data: frontmatter, excerpt, content } = grayMatter2(fileContent, {
        excerpt: true
      });
      if (!frontmatter.title) {
        frontmatter.title = getDefaultTitle2(content);
      }
      frontmatter.title = `${frontmatter.title}`;
      const date = yield frontmatter.date || datePromise;
      frontmatter.date = formatDate2(date);
      frontmatter.description = (_b = yield (_a = ops == null ? void 0 : ops.renderExpect) == null ? void 0 : _a.call(ops, content, __spreadValues({}, frontmatter))) != null ? _b : frontmatter.description || excerpt || getTextSummary2(content, 100);
      frontmatter.cover = ((_d = frontmatter.cover) != null ? _d : (_c = fileContent.match(imageRegex2)) == null ? void 0 : _c[1]) || "";
      const url = config.site.base + normalizePath2(import_path.default.relative(config.srcDir, file)).replace(/(^|\/)index\.md$/, "$1").replace(/\.md$/, config.cleanUrls ? "" : ".html");
      posts.push({
        filepath: file,
        fileContent,
...
function genFeed(config, rssOptions) {
  return __async(this, null, function* () {
    ...
    if (!rssOptions)
      return;
    const srcDir = config.srcDir.replace(config.root, "").replace(/^\//, "") || ((_a = import_process.default.argv.slice(2)) == null ? void 0 : _a[1]) || ".";
    const { baseUrl, filename } = rssOptions;
    const _b = rssOptions, { renderHTML } = _b, restOps = __objRest(_b, ["renderHTML"]);
    const feed = new import_feed.Feed(__spreadValues({
      id: rssOptions.baseUrl,
      link: rssOptions.baseUrl
    }, restOps));
    const posts = yield getPostsData(srcDir, config, rssOptions);
    for (const post of posts) {
      const { title, description, date, frontmatter, url } = post;
      const author = frontmatter.author || ((_c = rssOptions.author) == null ? void 0 : _c.name);
      const authorInfo = (_d = rssOptions.authors) == null ? void 0 : _d.find((v) => v.name === author);
      ...
      feed.addItem({
        ...
        link,
        description,
        content: (_e = htmlCache.get(post.filepath)) == null ? void 0 : _e.replaceAll("&ZeroWidthSpace;", ""),
        author: [
          __spreadValues({
            name: author
          }, authorInfo)
    ...
    const RSSFilepath = import_path.default.join(config.outDir, RSSFilename);
    yield import_fs.default.promises.writeFile(RSSFilepath, feed.rss2());
    if ((_f = rssOptions.log) != null ? _f : true) {
    ...
    async generateBundle(_, bundle) {
      ...
      for (const page of blogConfig.pagesData) {
        ...
        try {
          ...
          vitepressConfig.logger.warn(e2?.message);
        }
      }
    }
  };
